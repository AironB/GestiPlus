    ...
    class clsFactura
    {
        public class CreaTicket
        {
            ...
            public void TextoCentro(string par1)
            {
                ...
                max = (int)(75 - parte1.Length) / 2;         // saca la cantidad de espacios libres y divide entre dos
                for (int i = 0; i < max; i++)                // **********
                {
            ...
            public void TextoExtremos(string par1, string par2)
            {
                ...
                {
                    cort = max - 75;
                    parte1 = par1.Remove(75, cort);          // si par1 es mayor que 18 lo corta
                }
                else { parte1 = par1; }                      // **********
                ...
                {
                    cort = max - 75;
                    parte2 = par2.Remove(75, cort);          // si par2 es mayor que 18 lo corta
                }
                else { parte2 = par2; }
            ...
            public void AgregaTotales(string par1, double total)
            {
                ...
                {
                    cort = max - 75;
                    parte1 = par1.Remove(75, cort);          // si es mayor que 25 lo corta
                }
                else { parte1 = par1; }                      // **********
                ticket = parte1;
